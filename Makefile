...
SRC		= ft_atoi.c ft_atoi_long.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c \
ft_isascii.c is_number.c bubble_sort.c ft_isdigit.c ft_isprint.c ft_is_whitespace.c ft_strchr.c ft_itoa.c\
